// Package genshin provides a client for interacting with the EnkaNetwork API to fetch
// Genshin Impact player data, including profiles, characters, and equipment.
//
// The package offers a high-level interface to access various features of Genshin Impact
// player data through the EnkaNetwork API, including:
//   - Fetching player profiles with detailed character information
//   - Accessing character builds, weapons, and artifacts
//   - Retrieving player statistics and achievements
...
//	fmt.Println("Player:", profile.PlayerInfo.Nickname)
...
//   - Rate limit exceeded
//
// For more information about the EnkaNetwork Genshin Impact API, see:
