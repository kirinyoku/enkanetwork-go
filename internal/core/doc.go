...
// # Rate Limiting
//
// The client includes built-in support for handling rate limits and other retryable
// responses. By default, it makes up to 3 attempts, respects Retry-After when
// present, and uses a fixed fallback delay. Retry behavior can be configured
// through Options.Retry.
package core
